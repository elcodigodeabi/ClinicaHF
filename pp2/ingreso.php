¡Claro! Puedo ayudarte a agregar el campo DNI al formulario. Aquí tienes la versión modificada del formulario HTML con el campo DNI incluido:
...
<body>
    ...
    <form method="post" action="guardarturno.php">
        ...
        <input type="number" id="dni" name="dni" required minlength="8" maxlength="8"><br><br>
...
En este formulario, he agregado un nuevo campo llamado "DNI" con el tipo de entrada `number` y restricciones mínimas y máximas para asegurar que tenga exactamente 8 dígitos.